...
// Anima coração formando "Gabriela"
const nomeGabriela = document.querySelector('.nome-gabriela');
const posicoesGabriela = [
  // G
  [0,0],[0,1],[0,2],[1,0],[2,0],[3,0],[3,1],[3,2],[2,2],[1,2],
  // A
  [0,4],[1,3],[1,5],[2,3],[2,4],[2,5],[3,3],[3,5],[4,3],[4,5],
  // B
  [0,7],[1,7],[2,7],[3,7],[4,7],[0,8],[2,8],[4,8],[1,9],[3,9],
  // R
  [0,11],[1,11],[2,11],[3,11],[4,11],[0,12],[2,12],[1,13],[3,13],[4,13],
  // I
  [0,15],[1,15],[2,15],[3,15],[4,15],
  // E
  [0,17],[1,17],[2,17],[3,17],[4,17],[0,18],[2,18],[4,18],
  // L
  [0,20],[1,20],[2,20],[3,20],[4,20],[4,21],
  // A
  [0,23],[1,22],[1,24],[2,22],[2,23],[2,24],[3,22],[3,24],[4,22],[4,24]
];
...
// Após coração, inicia a cena do pedido
setTimeout(() => {
...
function gerarCacheado() {
  const pos = [
    [85,35],[95,30],[105,30],[115,35],[120,45],
    [115,55],[105,65],[95,65],[85,55],[80,45]
  ];
  return pos.map(([x,y]) => `<circle cx="${x}" cy="${y}" r="5" fill="black"/>`).join('');
}
